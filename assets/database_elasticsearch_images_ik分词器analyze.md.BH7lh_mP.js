import{_ as s,c as n,o as t,ag as p}from"./chunks/framework.C0zBmBgP.js";const r=JSON.parse('{"title":"install","description":"","frontmatter":{},"headers":[],"relativePath":"database/elasticsearch/images/ik分词器analyze.md","filePath":"database/elasticsearch/images/ik分词器analyze.md"}'),i={name:"database/elasticsearch/images/ik分词器analyze.md"};function e(l,a,o,c,u,d){return t(),n("div",null,a[0]||(a[0]=[p(`<h1 id="install" tabindex="-1">install <a class="header-anchor" href="#install" aria-label="Permalink to &quot;install&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>bin/elasticsearch-plugin install https://github.com/infinilabs/analysis-ik/releases/download/v7.17.18/elasticsearch-analysis-ik-7.17.18.zip</span></span></code></pre></div><p>ik 有俩中分词方式</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># ik_smart 最少切分</span></span>
